...
int main() {
    ...
    char codigo1[4], codigo2[4]; //Armazena a string de três dígitos que representa o código que divide os estado.
    ...
    printf("Digite o nome da cidade(somente um nome): \n"); //Solicita que usuário digite o nome da cidade correspondente ao estado.
    ...
    switch (opcaoMenu) { //O código da case será executado quando um valor da variável for selecionado pelo usuário.
        ...
        default:
            printf("Opção inválida! Tente novamente.\n"); //Caso a escolha não esteja entre as opções válidas.
    }
...
//Por fim, calcula-se a soma dos dois atributos escolhidos por carta.
